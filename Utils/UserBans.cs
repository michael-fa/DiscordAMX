    ...
    public static class UserBans
    {
        public static void Add(string userid)
        {
            ...
            foreach (string line in whole_file)
            {
                ...
                {
                    Program.m_Logger.Error("[ban] User " + userid + " is already banned.");
                    return;
                }
            }
            File.AppendAllText(System.AppContext.BaseDirectory + "bans.txt", "\n" + userid);
            Program.m_Logger.Write("[ban] User " + userid + " has been banned!");
        }
        ...
        public static void Remove(string userid)
        {
            ...
            foreach (string line in whole_file)
            {
                ...
                if (line.Contains(userid))
                {
                    ...
                    Program.m_Logger.Write("[ban] User " + userid + " has been removed from the banlist!");
                }
            }
            ...
            else Program.m_Logger.Error("[ban] User " + userid + " has not been banned yet!");
